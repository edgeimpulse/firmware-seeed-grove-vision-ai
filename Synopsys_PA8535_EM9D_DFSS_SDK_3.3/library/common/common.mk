...
LIB_COMMON_ASMSRCDIR	= $(LIB_COMMON_DIR)/ez_sio $(LIB_COMMON_DIR)/ringbuffer $(LIB_COMMON_DIR)/xprintf
LIB_COMMON_CSRCDIR	= $(LIB_COMMON_DIR)/ez_sio $(LIB_COMMON_DIR)/ringbuffer $(LIB_COMMON_DIR)/xprintf
LIB_COMMON_INCDIR	= $(LIB_COMMON_DIR)/ez_sio $(LIB_COMMON_DIR)/ringbuffer $(LIB_COMMON_DIR)/xprintf
